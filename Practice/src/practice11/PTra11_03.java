...
public class PTra11_03 {
	...
	public static void main(String[] args) {
		...
		// ★ sumメソッドを呼び出してください
		PTra11_03 ptrat = new PTra11_03();
		ptrat.sum(10, 50);

		 //↑staticが、ついてるので↓のstaticがついてないメソッドからは引数は渡せない
         //そこで、↑のメソッドの中でPTra11_03クラスをインスタンス化する。（newで定義）
		 //定義したときの変数．sum (引数)今回はintなので整数で解決することができる。
	}
